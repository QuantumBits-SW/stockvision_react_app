...
const InputField = ({ label, Icon, autoComplete, onChange, checked }) => {
  return (
    <div className="group flex flex-row border-1 border-black/20 rounded-[30px] px-4 gap-2 items-center mb-2 focus-within:border-black/70">
